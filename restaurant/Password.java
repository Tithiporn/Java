...
public class Password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmailPassword = (EditText)findViewById(R.id.EmailresetPass);
                    ...
                    firebaseAuth.sendPasswordResetEmail(useremail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(Password.this, "ResetPassword Email is already sent", Toast.LENGTH_SHORT).show();
                                finish();
                                startActivity(new Intent(Password.this, SignIn.class));
                            }else{
                                Toast.makeText(Password.this,"Sending Email Error", Toast.LENGTH_SHORT).show();
                            }
