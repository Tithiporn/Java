...
public class Dessert extends AppCompatActivity {
    ...
    public void placeOder(View view) {
        Intent i =  new Intent(Dessert.this, OrderDetail.class);
    ...
    public void LinktoDrink(View view) {
        ...
        startActivity(new Intent(Dessert.this, Drink.class));
    }

    public void LinktoDessert(View view) {
        startActivity(new Intent(Dessert.this, Dessert.class));
    }

    public void LinktoAlacarte(View view) {
        startActivity(new Intent(Dessert.this, Alarcarte.class));
    }
