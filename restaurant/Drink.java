...
public class Drink extends AppCompatActivity {
    ...
    public void placeOder(View view) {
        Intent i =  new Intent(Drink.this, OrderDetail.class);
    ...
    public void LinktoDrink(View view) {
        ...
        startActivity(new Intent(Drink.this, Drink.class));
    }

    public void LinktoDessert(View view) {
        startActivity(new Intent(Drink.this, Dessert.class));
    }

    public void LinktoAlacarte(View view) {
        startActivity(new Intent(Drink.this, Alarcarte.class));
    }
}
